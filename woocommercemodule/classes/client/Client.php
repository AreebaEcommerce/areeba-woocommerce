...
namespace WoocommerceModule\Client;

use WoocommerceModule\Client\CustomerProfile\CustomerData;
use WoocommerceModule\Client\CustomerProfile\DeleteProfileResponse;
use WoocommerceModule\Client\CustomerProfile\GetProfileResponse;
use WoocommerceModule\Client\CustomerProfile\PaymentInstrument;
use WoocommerceModule\Client\CustomerProfile\UpdateProfileResponse;
use WoocommerceModule\Client\Json\ErrorResponse;
use WoocommerceModule\Client\Exception\RateLimitException;
use WoocommerceModule\Client\Schedule\ScheduleData;
use WoocommerceModule\Client\Exception\ClientException;
use WoocommerceModule\Client\Exception\InvalidValueException;
use WoocommerceModule\Client\Exception\TimeoutException;
use WoocommerceModule\Client\Http\CurlClient;
use WoocommerceModule\Client\Http\Response;
use WoocommerceModule\Client\StatusApi\StatusRequestData;
use WoocommerceModule\Client\Transaction\Base\AbstractTransaction;
use WoocommerceModule\Client\Transaction\Capture;
use WoocommerceModule\Client\Transaction\Debit;
use WoocommerceModule\Client\Transaction\Deregister;
use WoocommerceModule\Client\Transaction\Payout;
use WoocommerceModule\Client\Transaction\Preauthorize;
use WoocommerceModule\Client\Transaction\Refund;
use WoocommerceModule\Client\Transaction\Register;
use WoocommerceModule\Client\Transaction\Result;
use WoocommerceModule\Client\Transaction\VoidTransaction;
use WoocommerceModule\Client\Xml\Generator;
use WoocommerceModule\Client\Xml\Parser;
 ...
 * Class Client
 *
 * @package WoocommerceModule\Client
 */
class Client {
     ...
     * @var string
     */
    protected static $gatewayUrl = 'https://gateway.areebapayment.com/';
     ...
     *
     * @param \WoocommerceModule\Client\Transaction\VoidTransaction $transactionData
     *
     * @return Result
     * @throws ClientException
     * @throws InvalidValueException
