...
namespace WoocommerceModule\Client\Http;

use WoocommerceModule\Client\Client;
use WoocommerceModule\Client\Http\Exception\ClientException;

/**
 * Class CurlClient
 *
 * @package WoocommerceModule\Client\Http
 */
