...
namespace WoocommerceModule\Client\Xml;

use WoocommerceModule\Client\Data\CreditCardCustomer;
use WoocommerceModule\Client\Data\Customer;
use WoocommerceModule\Client\Data\IbanCustomer;
use WoocommerceModule\Client\Data\Request;
use WoocommerceModule\Client\Exception\InvalidValueException;
use WoocommerceModule\Client\Schedule\ScheduleData;
use WoocommerceModule\Client\Exception\TypeException;
 ...
 * Class Generator
 *
 * @package WoocommerceModule\Client\Xml
 */
class Generator {
     ...
     * @var string
     */
    protected $namespaceRoot = 'http://gateway.areebapayment.com';
    ...
    /**
     * @param \WoocommerceModule\Client\Transaction\VoidTransaction $transaction
     * @param $method
     *
     * @return \DOMElement
     */
